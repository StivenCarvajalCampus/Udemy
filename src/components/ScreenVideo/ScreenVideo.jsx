    ...
    return (
      <div className="w-full">
        ...
        <div className="video-section">
          ...
          <div className="bg-background/20 dark:bg-default-100/50 flex justify-end sections-container">
            <h1>Aprende Git:</h1>
              ...
              {data.map((section, i) => {
                ...
                return (
                  <div key={i} className="custom-container" >
                    ...
                    <details open={sectionNumber === selectedSectionNumber}>
                      ...
                      <div className="videos">
                        {videos.map((videoObj, index) => {
                          ...
                          return (
                            <div key={index} >
                              <button className='custom-button' onClick={() => MIFUNCION(video.video)}>{video.Titulo}</button>
