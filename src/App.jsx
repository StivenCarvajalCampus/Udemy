    ...
    >
      <div className="flex flex-col justify-center items-center ">
        ...
        <CardHeader className="pb-0 px-10 flex-col items-start">
          ...
          <h4 className="font-bold text-large text-teal-50">Skillup Education</h4>
        </CardHeader>
        ...
        <Button className="w-24 max-h-full mt-4 cursor-progress bg-indigo-500 shadow-lg shadow-indigo-500/50 outline-blue-500">
          Login Discord
        </Button>
      </div>
